  ...
  return (
    <main className=" w-screen text-black  md:pl-[3%] flex flex-col items-center pb-32 2xl:pb pt-32 md:pt-20">
      ...
      <div className="w-[80vw] md:flex md:space-x-4 space-y-4 md:space-y-0 mb-4">
        <NewsItem data={newsData.financeNews[1]} />
        <NewsItem data={newsData.financeNews[2]} />
        <NewsItem data={newsData.financeNews[3]} />
      </div>
      <div className="w-[80vw] md:flex md:space-x-4 space-y-4 md:space-y-0 mb-4">
        <NewsItem data={newsData.financeNews[4]} />
        <NewsItem data={newsData.financeNews[5]} />
        <NewsItem data={newsData.financeNews[6]} />
      </div>
      <div className="w-[80vw] md:flex md:space-x-4 space-y-4 md:space-y-0 mb-4">
        <NewsItem data={newsData.financeNews[7]} />
        <NewsItem data={newsData.financeNews[8]} />
        <NewsItem data={newsData.financeNews[9]} />
      </div>
    </main>
  );
};
