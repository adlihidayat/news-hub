...
const page = () => {
  ...
  console.log(newsData.searchResults);
        ...
        <>
          {newsData.searchResults ? (
            ...
            <div className="flex flex-col items-center justify-center h-80 pb-20">
              <p className=" mb-3 md:mb-5 md:text-3xl">news not found</p>
              <Link
                href={"/"}
                className=" bg-black rounded-full py-1 px-5 text-sm text-white animation-smooth hover:opacity-50"
              >
          ...
          <section className="w-[80vw]">
            ...
            <div className="grid grid-cols-1 gap-y-3 lg:gap-x-3 lg:grid-cols-3">
              <OtherNews id={0} data={newsData.topHeadlines[0]} />
              <OtherNews id={1} data={newsData.topHeadlines[1]} />
              <OtherNews id={2} data={newsData.topHeadlines[2]} />
              <OtherNews id={3} data={newsData.topHeadlines[3]} />
              <OtherNews id={4} data={newsData.topHeadlines[4]} />
              <OtherNews id={5} data={newsData.topHeadlines[5]} />
            </div>
          </section>
        </>
      ) : (
