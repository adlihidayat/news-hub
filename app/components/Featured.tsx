...
const NewsItem = ({ data, style, title, id }: any) => {
...
const Featured = ({ newsData }: any) => {
  return (
    <section className=" w-screen text-black  md:pl-[3%] flex flex-col md:flex-row md:justify-center items-center pb-32 2xl:pb">
